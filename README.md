...
| `benchmark/` | Reproducible multi-module benchmark vs real GnuCOBOL — **27/27 certified + Ed25519-verified, both sides sandboxed in pinned containers, IR validated by the Rust core on every run** — + external parser-coverage sweep; see `benchmark/RESULTS.md` and the 9-finding log in `benchmark/README.md` | **built** |
